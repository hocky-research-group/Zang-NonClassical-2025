...
parser.add_argument('--lattice_repeats', action= "store",nargs ="*", default=15, dest = "lattice_repeats", type = int)
...
parser.add_argument('--radii',action="store", nargs="*", default='85,105',dest="radii",type=str)
parser.add_argument('--fraction_positive', action= "store", nargs="*", default=0.5, dest="fraction_positive", type=float)
parser.add_argument('--debye_length',action="store", nargs="*", default=5.3, dest="debye_length",type=float)
...
parser.add_argument('--seed',action="store", nargs="*", default=1, dest="seed",type=int)
print("")
